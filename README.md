# Quantum Mechanics: Approximation Methods and Real Systems
...
- `images/quantum-mechanics-vol3-fig-NN.svg` — static SVG (→ PNG for EPUB)
- `d3/quantum-mechanics-vol3-fig-NN.html` — interactive D3 HTML
