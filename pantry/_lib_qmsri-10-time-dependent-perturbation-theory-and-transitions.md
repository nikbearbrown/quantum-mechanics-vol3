...
- The chapter moves through The interaction picture, The resonance lineshape, The exact Rabi solution — and where PT fails, Fermi's golden rule (which is Dirac's), and related ideas.
...
![Schematic of Rabi's molecular-beam apparatus. Polarizer magnet selects spin orientation, interaction region with oscillating RF coil drives transitions, analyzer magnet selects opposite spin, detector measures beam in...](../images/10-time-dependent-perturbation-theory-and-transitions-fig-01.png)
*Figure 10.1 — Rabi 1938*

![Resonance lineshape function plotted at three increasing times. At short times, the peak is broad and low. At longer times, the peak narrows and grows taller. As t goes to infinity, the function becomes proportional t...](../images/10-time-dependent-perturbation-theory-and-transitions-fig-02.png)
*Figure 10.2 — sin²(Δωt/2)/Δω² Narrows into a Delta Function*

![Plot of transition probability versus Omega t. Exact Rabi solution oscillates between 0 and 1 with period 2 pi over Omega. First-order PT gives a parabolic Omega t over 2 squared that crosses P=1 at Omega t equals 2 a...](../images/10-time-dependent-perturbation-theory-and-transitions-fig-03.png)
*Figure 10.3 — Rabi Oscillation vs First-Order PT*

![Three Rabi oscillation curves at detunings Δ=0, Δ=Ω, and Δ=2Ω. On resonance: oscillates fully between 0 and 1. Off resonance: maximum probability is Ω squared over (Ω squared + Δ squared); oscillation frequency is the...](../images/10-time-dependent-perturbation-theory-and-transitions-fig-04.png)
*Figure 10.4 — Off-Resonance Rabi*

![Plot of total probability versus time. For N=2 final states, beating-like Rabi oscillations. For N=10, smoother oscillations. For N=50, the sum smooths into a linear ramp with slope W given by Fermi's golden rule. Lin...](../images/10-time-dependent-perturbation-theory-and-transitions-fig-05.png)
*Figure 10.5 — Continuum Smoothing*
